...
final class ChainedFunctor implements Functor
{
    ...
    public Object applyTo(Object par1Obj)
    {
        ...
        {
            throw JsonNodeDoesNotMatchChainedJsonNodeSelectorException.func_74698_b(jsonnodedoesnotmatchchainedjsonnodeselectorexception, parentJsonNodeSelector);
        }
        ...
        {
            throw JsonNodeDoesNotMatchChainedJsonNodeSelectorException.func_74699_a(jsonnodedoesnotmatchchainedjsonnodeselectorexception1, parentJsonNodeSelector);
        }
