...
class JsonObjectNodeBuilder_List extends HashMap
{
    ...
    JsonObjectNodeBuilder_List(JsonObjectNodeBuilder par1JsonObjectNodeBuilder)
    {
        ...
        for (Iterator iterator = JsonObjectNodeBuilder.func_74607_a(nodeBuilder).iterator(); iterator.hasNext(); put(jsonfieldbuilder.func_74724_b(), jsonfieldbuilder.buildValue()))
        {
