...
public class AnvilSaveConverter extends SaveFormatOld
{
    ...
    public List getSaveList()
    {
        ...
        for (int j = 0; j < i; j++)
        {
            ...
            boolean flag = worldinfo.getSaveVersion() != func_75812_c();
            ...
            long l = 0L;
            arraylist.add(new SaveFormatComparator(s, s1, worldinfo.getLastTimePlayed(), l, worldinfo.func_76077_q(), flag, worldinfo.isHardcoreModeEnabled(), worldinfo.func_76086_u()));
        }
    ...
    public boolean isOldMapFormat(String par1Str)
    {
        ...
        return worldinfo != null && worldinfo.getSaveVersion() != func_75812_c();
    }
    ...
    public boolean convertMapFormat(String par1Str, IProgressUpdate par2IProgressUpdate)
    {
        ...
        func_75813_a(new File(file, "region"), arraylist, ((WorldChunkManager)(obj)), 0, i, par2IProgressUpdate);
        func_75813_a(new File(file1, "region"), arraylist1, new WorldChunkManagerHell(BiomeGenBase.hell, 1.0F, 0.0F), arraylist.size(), i, par2IProgressUpdate);
        func_75813_a(new File(file2, "region"), arraylist2, new WorldChunkManagerHell(BiomeGenBase.sky, 0.5F, 0.0F), arraylist.size() + arraylist1.size(), i, par2IProgressUpdate);
    ...
    private void func_75813_a(File par1File, Iterable par2Iterable, WorldChunkManager par3WorldChunkManager, int par4, int par5, IProgressUpdate par6IProgressUpdate)
    {
        ...
        for (Iterator iterator = par2Iterable.iterator(); iterator.hasNext(); par6IProgressUpdate.setLoadingProgress(i))
        {
            ...
            func_75811_a(par1File, file, par3WorldChunkManager, par4, par5, par6IProgressUpdate);
            par4++;
