...
public class Block
{
    ...
    /** stoneDoubleSlab */
    public static final BlockHalfSlab stairDouble;

    /** stoneSingleSlab */
    public static final BlockHalfSlab stairSingle;
    ...
    {
        return AxisAlignedBB.getAABBPool().addOrModifyAABBInPool((double)par2 + minX, (double)par3 + minY, (double)par4 + minZ, (double)par2 + maxX, (double)par3 + maxY, (double)par4 + maxZ);
    }
    ...
    public float func_71908_a(EntityPlayer par1EntityPlayer, World par2World, int par3, int par4, int par5)
    {
    ...
    public MovingObjectPosition collisionRayTrace(World par1World, int par2, int par3, int par4, Vec3 par5Vec3, Vec3 par6Vec3)
    {
        ...
        if (vec3 != null && (vec3_6 == null || par5Vec3.squareDistanceTo(vec3) < par5Vec3.squareDistanceTo(vec3_6)))
        {
            vec3_6 = vec3;
        }

        if (vec3_1 != null && (vec3_6 == null || par5Vec3.squareDistanceTo(vec3_1) < par5Vec3.squareDistanceTo(vec3_6)))
        {
            vec3_6 = vec3_1;
        }

        if (vec3_2 != null && (vec3_6 == null || par5Vec3.squareDistanceTo(vec3_2) < par5Vec3.squareDistanceTo(vec3_6)))
        {
            vec3_6 = vec3_2;
        }

        if (vec3_3 != null && (vec3_6 == null || par5Vec3.squareDistanceTo(vec3_3) < par5Vec3.squareDistanceTo(vec3_6)))
        {
            vec3_6 = vec3_3;
        }

        if (vec3_4 != null && (vec3_6 == null || par5Vec3.squareDistanceTo(vec3_4) < par5Vec3.squareDistanceTo(vec3_6)))
        {
            vec3_6 = vec3_4;
        }

        if (vec3_5 != null && (vec3_6 == null || par5Vec3.squareDistanceTo(vec3_5) < par5Vec3.squareDistanceTo(vec3_6)))
        {
            vec3_6 = vec3_5;
        }
     ...
     */
    public void updateBlockMetadata(World world, int i, int j, int k, int l, float f, float f1, float f2)
    {
    }
     ...
     */
    public void onTimeChanged(World world, long l, long l1)
    {
    }
    ...
    static
    {
        ...
        cobblestone = (new Block(4, 16, Material.rock)).setHardness(2.0F).setResistance(10F).setStepSound(soundStoneFootstep).setBlockName("stonebrick").setCreativeTab(CreativeTabs.tabBlock);
        ...
        bedrock = (new Block(7, 17, Material.rock)).setBlockUnbreakable().setResistance(6000000F).setStepSound(soundStoneFootstep).setBlockName("bedrock").disableStats().setCreativeTab(CreativeTabs.tabBlock);
        ...
        blockLapis = (new Block(22, 144, Material.rock)).setHardness(3F).setResistance(5F).setStepSound(soundStoneFootstep).setBlockName("blockLapis").setCreativeTab(CreativeTabs.tabBlock);
        ...
        stairDouble = (BlockHalfSlab)(new BlockStep(43, true)).setHardness(2.0F).setResistance(10F).setStepSound(soundStoneFootstep).setBlockName("stoneSlab");
        stairSingle = (BlockHalfSlab)(new BlockStep(44, false)).setHardness(2.0F).setResistance(10F).setStepSound(soundStoneFootstep).setBlockName("stoneSlab");
        brick = (new Block(45, 7, Material.rock)).setHardness(2.0F).setResistance(10F).setStepSound(soundStoneFootstep).setBlockName("brick").setCreativeTab(CreativeTabs.tabBlock);
        ...
        cobblestoneMossy = (new Block(48, 36, Material.rock)).setHardness(2.0F).setResistance(10F).setStepSound(soundStoneFootstep).setBlockName("stoneMoss").setCreativeTab(CreativeTabs.tabBlock);
        ...
        stoneOvenIdle = (new BlockFurnace(61, false)).setHardness(3.5F).setStepSound(soundStoneFootstep).setBlockName("furnace").setRequiresSelfNotify().setCreativeTab(CreativeTabs.tabDeco);
        ...
        oreRedstone = (new BlockRedstoneOre(73, 51, false)).setHardness(3F).setResistance(5F).setStepSound(soundStoneFootstep).setBlockName("oreRedstone").setRequiresSelfNotify().setCreativeTab(CreativeTabs.tabBlock);
        ...
        torchRedstoneActive = (new BlockRedstoneTorch(76, 99, true)).setHardness(0.0F).setLightValue(0.5F).setStepSound(soundWoodFootstep).setBlockName("notGate").setRequiresSelfNotify().setCreativeTab(CreativeTabs.tabRedstone);
        ...
        netherBrick = (new Block(112, 224, Material.rock)).setHardness(2.0F).setResistance(10F).setStepSound(soundStoneFootstep).setBlockName("netherBrick").setCreativeTab(CreativeTabs.tabBlock);
        ...
        endPortalFrame = (new BlockEndPortalFrame(120)).setStepSound(soundGlassFootstep).setLightValue(0.125F).setHardness(-1F).setBlockName("endPortalFrame").setRequiresSelfNotify().setResistance(6000000F).setCreativeTab(CreativeTabs.tabDeco);
        whiteStone = (new Block(121, 175, Material.rock)).setHardness(3F).setResistance(15F).setStepSound(soundStoneFootstep).setBlockName("whiteStone").setCreativeTab(CreativeTabs.tabBlock);
        ...
        redstoneLampIdle = (new BlockRedstoneLight(123, false)).setHardness(0.3F).setStepSound(soundGlassFootstep).setBlockName("redstoneLight").setCreativeTab(CreativeTabs.tabRedstone);
        ...
        woodDoubleSlab = (BlockHalfSlab)(new BlockWoodSlab(125, true)).setHardness(2.0F).setResistance(5F).setStepSound(soundWoodFootstep).setBlockName("woodSlab");
        woodSingleSlab = (BlockHalfSlab)(new BlockWoodSlab(126, false)).setHardness(2.0F).setResistance(5F).setStepSound(soundWoodFootstep).setBlockName("woodSlab");
        cocoa = (new BlockCocoa(127)).setHardness(0.2F).setResistance(5F).setStepSound(soundWoodFootstep).setBlockName("cocoa").setRequiresSelfNotify();
        stairsSandStone = (new BlockStairs(128, sandStone, 0)).setBlockName("stairsSandStone").setRequiresSelfNotify();
        oreEmerald = (new BlockOre(129, 171)).setHardness(3F).setResistance(5F).setStepSound(soundStoneFootstep).setBlockName("oreEmerald");
        enderChest = (new BlockEnderChest(130)).setHardness(22.5F).setResistance(1000F).setStepSound(soundStoneFootstep).setBlockName("enderChest").setRequiresSelfNotify().setLightValue(0.5F);
        tripWireSource = (BlockTripWireSource)(new BlockTripWireSource(131)).setBlockName("tripWireSource").setRequiresSelfNotify();
        tripWire = (new BlockTripWire(132)).setBlockName("tripWire").setRequiresSelfNotify();
        blockEmerald = (new BlockOreStorage(133, 25)).setHardness(5F).setResistance(10F).setStepSound(soundMetalFootstep).setBlockName("blockEmerald");
        stairsWoodSpruce = (new BlockStairs(134, planks, 1)).setBlockName("stairsWoodSpruce").setRequiresSelfNotify();
        stairsWoodBirch = (new BlockStairs(135, planks, 2)).setBlockName("stairsWoodBirch").setRequiresSelfNotify();
        stairsWoodJungle = (new BlockStairs(136, planks, 3)).setBlockName("stairsWoodJungle").setRequiresSelfNotify();
        ...
        Item.itemsList[stairSingle.blockID] = (new ItemSlab(stairSingle.blockID - 256, stairSingle, stairDouble, false)).setItemName("stoneSlab");
        Item.itemsList[stairDouble.blockID] = (new ItemSlab(stairDouble.blockID - 256, stairSingle, stairDouble, true)).setItemName("stoneSlab");
