...
public class BlockCactus extends Block
{
    ...
    {
        float f = 0.0625F;
        return AxisAlignedBB.getAABBPool().addOrModifyAABBInPool((float)par2 + f, par3, (float)par4 + f, (float)(par2 + 1) - f, (float)(par3 + 1) - f, (float)(par4 + 1) - f);
    }
    ...
    {
        float f = 0.0625F;
        return AxisAlignedBB.getAABBPool().addOrModifyAABBInPool((float)par2 + f, par3, (float)par4 + f, (float)(par2 + 1) - f, par3 + 1, (float)(par4 + 1) - f);
    }
