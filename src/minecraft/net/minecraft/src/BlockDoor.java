...
public class BlockDoor extends Block
{
    ...
    public boolean canPlaceBlockAt(World par1World, int par2, int par3, int par4)
    {
        ...
        {
            return par1World.func_72797_t(par2, par3 - 1, par4) && super.canPlaceBlockAt(par1World, par2, par3, par4) && super.canPlaceBlockAt(par1World, par2, par3 + 1, par4);
        }
    }
    ...
    {
        return blockMaterial != Material.iron ? Item.doorWood.shiftedIndex : Item.doorSteel.shiftedIndex;
    }
}
