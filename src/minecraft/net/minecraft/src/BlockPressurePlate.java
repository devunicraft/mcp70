...
public class BlockPressurePlate extends Block
{
    ...
    {
        return par1World.func_72797_t(par2, par3 - 1, par4) || BlockFence.func_72249_c(par1World.getBlockId(par2, par3 - 1, par4));
    }
    ...
    public void onNeighborBlockChange(World par1World, int par2, int par3, int par4, int par5)
    {
        ...
        if (!par1World.func_72797_t(par2, par3 - 1, par4) && !BlockFence.func_72249_c(par1World.getBlockId(par2, par3 - 1, par4)))
        {
            flag = true;
        }
    ...
    private void setStateIfMobInteractsWithPlate(World par1World, int par2, int par3, int par4)
    {
        ...
        {
            list = par1World.getEntitiesWithinAABBExcludingEntity(null, AxisAlignedBB.getAABBPool().addOrModifyAABBInPool((float)par2 + f, par3, (float)par4 + f, (float)(par2 + 1) - f, (double)par3 + 0.25D, (float)(par4 + 1) - f));
        }

        if (triggerMobType == EnumMobType.mobs)
        {
            list = par1World.getEntitiesWithinAABB(net.minecraft.src.EntityLiving.class, AxisAlignedBB.getAABBPool().addOrModifyAABBInPool((float)par2 + f, par3, (float)par4 + f, (float)(par2 + 1) - f, (double)par3 + 0.25D, (float)(par4 + 1) - f));
        }

        if (triggerMobType == EnumMobType.players)
        {
            list = par1World.getEntitiesWithinAABB(net.minecraft.src.EntityPlayer.class, AxisAlignedBB.getAABBPool().addOrModifyAABBInPool((float)par2 + f, par3, (float)par4 + f, (float)(par2 + 1) - f, (double)par3 + 0.25D, (float)(par4 + 1) - f));
        }
