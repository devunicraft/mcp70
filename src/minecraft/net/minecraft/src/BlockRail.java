...
public class BlockRail extends Block
{
    ...
    {
        return par1World.func_72797_t(par2, par3 - 1, par4);
    }
    ...
    public void onNeighborBlockChange(World par1World, int par2, int par3, int par4, int par5)
    {
        ...
        if (j == 2 && !par1World.func_72797_t(par2 + 1, par3, par4))
        {
            flag = true;
        }

        if (j == 3 && !par1World.func_72797_t(par2 - 1, par3, par4))
        {
            flag = true;
        }

        if (j == 4 && !par1World.func_72797_t(par2, par3, par4 - 1))
        {
            flag = true;
        }

        if (j == 5 && !par1World.func_72797_t(par2, par3, par4 + 1))
        {
            flag = true;
        }
