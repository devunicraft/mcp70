...
public class BlockSnow extends Block
{
    ...
    public AxisAlignedBB getCollisionBoundingBoxFromPool(World par1World, int par2, int par3, int par4)
    {
        ...
        if (i >= 3)
        {
            return AxisAlignedBB.getAABBPool().addOrModifyAABBInPool((double)par2 + minX, (double)par3 + minY, (double)par4 + minZ, (double)par2 + maxX, (float)par3 + 0.5F, (double)par4 + maxZ);
        }
        else
        {
            return null;
