...
public class ChestItemRenderHelper
{
    ...
    public void renderChest(Block par1Block, int par2, float par3)
    {
        ...
        {
            TileEntityRenderer.instance.renderTileEntityAt(field_78544_c, 0.0D, 0.0D, 0.0D, 0.0F);
        }
        else
        {
            TileEntityRenderer.instance.renderTileEntityAt(field_78543_b, 0.0D, 0.0D, 0.0D, 0.0F);
        }
    }
}
