...
public class Chunk
{
    ...
    {
        worldObj.field_72984_F.startSection("recheckGaps");
    ...
    public boolean setBlockIDWithMetadata(int par1, int par2, int par3, int par4, int par5)
    {
        ...
        {
            Block.blocksList[k].func_71927_h(worldObj, i1, par2, j1, l);
        }
        ...
        if (par4 != 0)
        {
            ...
            if (Block.blocksList[par4] instanceof BlockContainer)
            {
                ...
                if (tileentity == null)
                {
                    tileentity = ((BlockContainer)Block.blocksList[par4]).func_72274_a(worldObj);
    ...
    public TileEntity getChunkBlockTileEntity(int par1, int par2, int par3)
    {
        ...
        if (tileentity == null)
        {
            ...
            if (tileentity == null)
            {
                tileentity = ((BlockContainer)Block.blocksList[i]).func_72274_a(worldObj);
    ...
    public void fillChunk(byte par1ArrayOfByte[], int par2, int par3, boolean par4)
    {
        ...
        for (int j = 0; j < storageArrays.length; j++)
        {
            if ((par2 & 1 << j) != 0)
            {
                ...
                byte abyte0[] = storageArrays[j].func_76658_g();
        ...
        for (int k = 0; k < storageArrays.length; k++)
        {
            ...
            {
                NibbleArray nibblearray = storageArrays[k].func_76669_j();
