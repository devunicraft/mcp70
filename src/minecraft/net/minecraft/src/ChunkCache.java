...
public class ChunkCache implements IBlockAccess
{
    ...
    public int getLightValueExt(int par1, int par2, int par3, boolean par4)
    {
        ...
        if (par4)
        {
            ...
            if (i == Block.stairSingle.blockID || i == Block.woodSingleSlab.blockID || i == Block.tilledField.blockID || i == Block.stairCompactPlanks.blockID || i == Block.stairCompactCobblestone.blockID)
            {
