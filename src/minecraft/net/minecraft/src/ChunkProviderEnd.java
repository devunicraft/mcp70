...
public class ChunkProviderEnd implements IChunkProvider
{
    ...
    public void func_73189_a(int par1, int par2, byte par3ArrayOfByte[], BiomeGenBase par4ArrayOfBiomeGenBase[])
    {
        ...
        byte byte1 = 33;
        int j = byte0 + 1;
        densities = func_73187_a(densities, par1 * byte0, 0, par2 * byte0, i, byte1, j);
    ...
    public Chunk provideChunk(int par1, int par2)
    {
        ...
        func_73189_a(par1, par2, abyte0, biomesForGeneration);
        func_73188_b(par1, par2, abyte0, biomesForGeneration);
