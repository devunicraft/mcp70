...
{
    private static final WeightedRandomChestContent field_75014_c[];
    ...
    public boolean addComponentParts(World par1World, Random par2Random, StructureBoundingBox par3StructureBoundingBox)
    {
        ...
        switch (roomType)
        {
            ...
            case 2:
                ...
                func_74879_a(par1World, par3StructureBoundingBox, par2Random, 3, 4, 8, field_75014_c, 1 + par2Random.nextInt(4));
                break;
        }
    ...
    static
    {
        field_75014_c = (new WeightedRandomChestContent[]
                {
