...
public abstract class Container
{
    ...
    public void func_75132_a(ICrafting par1ICrafting)
    {
        ...
        else
        {
            ...
            par1ICrafting.func_71110_a(this, func_75138_a());
    ...
    public Slot func_75147_a(IInventory par1IInventory, int par2)
    {
        for (Iterator iterator = inventorySlots.iterator(); iterator.hasNext();)
        {
            ...
            if (slot.func_75217_a(par1IInventory, par2))
            {
                return slot;
            }
        }
        ...
        if (par2 == 0 || par2 == 1)
        {
            ...
            else
            {
                ...
                if (slot != null)
                {
                    ...
                    {
                        if (itemstack2.itemID != itemstack4.itemID || itemstack2.getHasSubtypes() && itemstack2.getItemDamage() != itemstack4.getItemDamage() || !ItemStack.func_77970_a(itemstack2, itemstack4))
                        {
                    ...
                    else if (itemstack2.itemID == itemstack4.itemID && itemstack4.getMaxStackSize() > 1 && (!itemstack2.getHasSubtypes() || itemstack2.getItemDamage() == itemstack4.getItemDamage()) && ItemStack.func_77970_a(itemstack2, itemstack4))
                    {
    ...
    {
        return !field_75148_f.contains(par1EntityPlayer);
    }
    ...
    public void func_75128_a(EntityPlayer par1EntityPlayer, boolean par2)
    {
        if (par2)
        {
            field_75148_f.remove(par1EntityPlayer);
        }
        else
        {
            field_75148_f.add(par1EntityPlayer);
        }
    }
    ...
    protected boolean mergeItemStack(ItemStack par1ItemStack, int par2, int par3, boolean par4)
    {
        ...
        if (par1ItemStack.isStackable())
        {
            while (par1ItemStack.stackSize > 0 && (!par4 && i < par3 || par4 && i >= par2))
            {
                ...
                if (itemstack != null && itemstack.itemID == par1ItemStack.itemID && (!par1ItemStack.getHasSubtypes() || par1ItemStack.getItemDamage() == itemstack.getItemDamage()) && ItemStack.func_77970_a(par1ItemStack, itemstack))
                {
