...
public class DataWatcher
{
    ...
    {
        return ((Byte)func_75691_i(par1).getObject()).byteValue();
    }

    public short getWatchableObjectShort(int par1)
    {
        return ((Short)func_75691_i(par1).getObject()).shortValue();
    }
    ...
    {
        return ((Integer)func_75691_i(par1).getObject()).intValue();
    }
    ...
    {
        return (String)func_75691_i(par1).getObject();
    }
    ...
    private WatchableObject func_75691_i(int par1)
    {
        ...
        catch (Throwable throwable)
        {
            ...
            crashreport.func_71507_a("EntityData ID", Integer.valueOf(par1));
    ...
    {
        WatchableObject watchableobject = func_75691_i(par1);
