...
public class EntityCrit2FX extends EntityFX
{
    ...
    public void onUpdate()
    {
        for (int i = 0; i < 16; i++)
        {
            ...
            {
                double d3 = field_70557_a.posX + (d * (double)field_70557_a.width) / 4D;
                double d4 = field_70557_a.boundingBox.minY + (double)(field_70557_a.height / 2.0F) + (d1 * (double)field_70557_a.height) / 4D;
                double d5 = field_70557_a.posZ + (d2 * (double)field_70557_a.width) / 4D;
