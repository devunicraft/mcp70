...
public class EntityDragon extends EntityDragonBase
{
    ...
    public double[] getMovementOffsets(int par1, float par2)
    {
        ...
        double d1 = MathHelper.func_76138_g(ringBuffer[j][0] - d);
    ...
    public void onLivingUpdate()
    {
        ...
        rotationYaw = MathHelper.func_76142_g(rotationYaw);
        ...
        if (worldObj.isRemote)
        {
            if (newPosRotationIncrements > 0)
            {
                ...
                double d6 = MathHelper.func_76138_g(newRotationYaw - (double)rotationYaw);
        ...
        else
        {
            ...
            double d11 = MathHelper.func_76138_g(d9 - (double)rotationYaw);
            ...
            Vec3 vec3 = Vec3.func_72437_a().func_72345_a(targetX - posX, targetY - posY, targetZ - posZ).normalize();
            Vec3 vec3_1 = Vec3.func_72437_a().func_72345_a(MathHelper.sin((rotationYaw * (float)Math.PI) / 180F), motionY, -MathHelper.cos((rotationYaw * (float)Math.PI) / 180F)).normalize();
            ...
            Vec3 vec3_2 = Vec3.func_72437_a().func_72345_a(motionX, motionY, motionZ).normalize();
