...
public class EntityFishHook extends Entity
{
    ...
    public void onUpdate()
    {
        ...
        if (fishPosRotationIncrements > 0)
        {
            ...
            double d4 = MathHelper.func_76138_g(fishYaw - (double)rotationYaw);
        ...
        for (int k = 0; k < j; k++)
        {
            ...
            AxisAlignedBB axisalignedbb1 = AxisAlignedBB.getAABBPool().addOrModifyAABBInPool(boundingBox.minX, d8, boundingBox.minZ, boundingBox.maxX, d9, boundingBox.maxZ);
