...
public class EntityLightningBolt extends EntityWeatherEffect
{
    ...
    public void onUpdate()
    {
        ...
        {
            double d = 3D;
            List list = worldObj.getEntitiesWithinAABBExcludingEntity(this, AxisAlignedBB.getAABBPool().addOrModifyAABBInPool(posX - d, posY - d, posZ - d, posX + d, posY + 6D + d, posZ + d));
            Entity entity;
