...
public class EntityPlayerSP extends EntityPlayer
{
    ...
    public EntityPlayerSP(Minecraft par1Minecraft, World par2World, Session par3Session, int par4)
    {
        ...
        {
            skinUrl = (new StringBuilder()).append("https://dl.dropbox.com/u/87115331/LauncherUnicraft/Skins/").append(StringUtils.func_76338_a(par3Session.username)).append(".png").toString();
        }
