...
public class GuiAchievements extends GuiScreen
{
    ...
    public GuiAchievements(StatFileWriter par1StatFileWriter)
    {
        ...
        char c = '\215';
        char c1 = '\215';
        field_74117_m = guiMapX = field_74124_q = AchievementList.openInventory.displayColumn * 24 - c / 2 - 12;
        field_74115_n = guiMapY = field_74123_r = AchievementList.openInventory.displayRow * 24 - c1 / 2;
    }
    ...
    {
        controlList.clear();
        controlList.add(new GuiSmallButton(1, width / 2 + 24, height / 2 + 74, 80, 20, StatCollector.translateToLocal("Terminer")));
    }
    ...
    public void updateScreen()
    {
        ...
        double d = field_74124_q - guiMapX;
    ...
    {
        int i = MathHelper.floor_double(field_74117_m + (guiMapX - field_74117_m) * (double)par3);
        int j = MathHelper.floor_double(field_74115_n + (guiMapY - field_74115_n) * (double)par3);
        ...
        for (int j3 = 0; j3 < AchievementList.achievementList.size(); j3++)
        {
            ...
            char c = Math.sin(((double)(Minecraft.func_71386_F() % 600L) / 600D) * Math.PI * 2D) <= 0.59999999999999998D ? '\202' : '\377';
            int i8 = 0xff000000;
        ...
        for (int i4 = 0; i4 < AchievementList.achievementList.size(); i4++)
        {
            ...
            {
                float f2 = Math.sin(((double)(Minecraft.func_71386_F() % 600L) / 600D) * Math.PI * 2D) >= 0.59999999999999998D ? 0.8F : 0.6F;
