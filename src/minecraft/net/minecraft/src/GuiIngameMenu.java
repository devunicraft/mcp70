...
public class GuiIngameMenu extends GuiScreen
{
    ...
    public void initGui()
    {
        ...
        controlList.add(new GuiButton(8, width / 2 - 100, height / 4 + 72 + byte0, StatCollector.translateToLocal("Site Unicraft")));
            ...
            case 8 :
                {
                    ...
                    java.net.URI url;
                    try {
                            url = new java.net.URI("http://unicraft.hebergratuit.com");
