...
public class GuiMainMenu extends GuiScreen
{
    ...
    private void func_73969_a(int par1, int par2, StringTranslate par3StringTranslate)
    {
        ...
        controlList.add(new GuiButton(2, width / 2 - 100, par1 + 12 + 12, 98, 20, par3StringTranslate.translateKey("menu.multiplayer")));
        controlList.add(UnicraftButton = new GuiButton(6, width / 2 - 0, par1 + 12 + 12, 98, 20, par3StringTranslate.translateKey("Unicraft")));
    }
    ...
    public void drawScreen(int par1, int par2, float par3)
    {
        ...
        GL11.glScalef(f, f, f);
        drawCenteredString(fontRenderer, splashText, 0, -8, 0xed1c24);
        GL11.glPopMatrix();
        String s = "Unicraft 1.3.1.A";
        ...
        drawString(fontRenderer, s, 2, height - 10, 0xed1c24);
        String s1 = "Copyright © Unicraft 2012";
        drawString(fontRenderer, s1, width - fontRenderer.getStringWidth(s1) - 2, height - 10, 0xed1c24);
