...
public class GuiOptions extends GuiScreen
{
    ...
    public void initGui()
    {
        ...
        controlList.add(new GuiButton(101, width / 2 - 152, (height / 6 + 96) - 6, 150, 20, stringtranslate.translateKey("options.video")));
        controlList.add(new GuiButton(100, width / 2 + 2, (height / 6 + 96) - 6, 150, 20, stringtranslate.translateKey("options.controls")));
        controlList.add(new GuiButton(102, width / 2 - 152, (height / 6 + 120) - 6, 150, 20, stringtranslate.translateKey("options.language")));
        controlList.add(new GuiButton(103, width / 2 + 2, (height / 6 + 120) - 6, 150, 20, stringtranslate.translateKey("options.chat.title")));
        controlList.add(new GuiButton(104, width / 2 + 2, (height / 6 + 144) - 6, 150, 20, stringtranslate.translateKey("options.snooper.view")));
        controlList.add(new GuiButton(200, width / 2 - 100, height / 6 + 168, stringtranslate.translateKey("Terminé")));
    }
