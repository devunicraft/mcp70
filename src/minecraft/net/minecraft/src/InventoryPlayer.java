...
public class InventoryPlayer implements IInventory
{
    ...
    public void func_70439_a(Item par1Item, int par2)
    {
        if (par1Item != null)
        {
            ...
            if (field_70456_f != null && field_70456_f.isItemEnchantable() && getInventorySlotContainItemAndDamage(field_70456_f.itemID, field_70456_f.getItemDamageForDisplay()) == currentItem)
            {
                return;
            }
