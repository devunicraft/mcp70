...
public class Item
{
    ...
    public boolean tryPlaceIntoWorld(ItemStack par1ItemStack, EntityPlayer par2EntityPlayer, World par3World, int i, int j, int k, int l, float f, float f1, float f2)
    {
        return false;
    }
    ...
    public boolean func_77660_a(ItemStack par1ItemStack, World par2World, int par3, int i, int j, int k, EntityLiving entityliving)
    {
        return false;
    }
    ...
    {
        return (new StringBuilder()).append("").append(StringTranslate.getInstance().translateNamedKey(getLocalItemName(par1ItemStack))).toString().trim();
    }
    ...
    static
    {
        ...
        arrow = (new Item(6)).setIconCoord(5, 2).setItemName("arrow").setTabToDisplayOn(CreativeTabs.tabCombat);
        diamond = (new Item(8)).setIconCoord(7, 3).setItemName("diamond").setTabToDisplayOn(CreativeTabs.tabMaterials);
        ingotIron = (new Item(9)).setIconCoord(7, 1).setItemName("ingotIron").setTabToDisplayOn(CreativeTabs.tabMaterials);
        ingotGold = (new Item(10)).setIconCoord(7, 2).setItemName("ingotGold").setTabToDisplayOn(CreativeTabs.tabMaterials);
        ...
        stick = (new Item(24)).setIconCoord(5, 3).setFull3D().setItemName("stick").setTabToDisplayOn(CreativeTabs.tabMaterials);
        bowlEmpty = (new Item(25)).setIconCoord(7, 4).setItemName("bowl").setTabToDisplayOn(CreativeTabs.tabMaterials);
        ...
        silk = (new ItemReed(31, Block.tripWire)).setIconCoord(8, 0).setItemName("string").setTabToDisplayOn(CreativeTabs.tabMaterials);
        feather = (new Item(32)).setIconCoord(8, 1).setItemName("feather").setTabToDisplayOn(CreativeTabs.tabMaterials);
        gunpowder = (new Item(33)).setIconCoord(8, 2).setItemName("sulphur").setPotionEffect(PotionHelper.gunpowderEffect).setTabToDisplayOn(CreativeTabs.tabMaterials);
        ...
        wheat = (new Item(40)).setIconCoord(9, 1).setItemName("wheat").setTabToDisplayOn(CreativeTabs.tabMaterials);
        ...
        flint = (new Item(62)).setIconCoord(6, 0).setItemName("flint").setTabToDisplayOn(CreativeTabs.tabMaterials);
        ...
        leather = (new Item(78)).setIconCoord(7, 6).setItemName("leather").setTabToDisplayOn(CreativeTabs.tabMaterials);
        bucketMilk = (new ItemBucketMilk(79)).setIconCoord(13, 4).setItemName("milk").setContainerItem(bucketEmpty);
        brick = (new Item(80)).setIconCoord(6, 1).setItemName("brick").setTabToDisplayOn(CreativeTabs.tabMaterials);
        clay = (new Item(81)).setIconCoord(9, 3).setItemName("clay").setTabToDisplayOn(CreativeTabs.tabMaterials);
        reed = (new ItemReed(82, Block.reed)).setIconCoord(11, 1).setItemName("reeds").setTabToDisplayOn(CreativeTabs.tabMaterials);
        paper = (new Item(83)).setIconCoord(10, 3).setItemName("paper").setTabToDisplayOn(CreativeTabs.tabMisc);
        book = (new Item(84)).setIconCoord(11, 3).setItemName("book").setTabToDisplayOn(CreativeTabs.tabMisc);
        slimeBall = (new Item(85)).setIconCoord(14, 1).setItemName("slimeball").setTabToDisplayOn(CreativeTabs.tabMisc);
        compass = (new Item(89)).setIconCoord(6, 3).setItemName("compass").setTabToDisplayOn(CreativeTabs.tabTools);
        pocketSundial = (new Item(91)).setIconCoord(6, 4).setItemName("clock").setTabToDisplayOn(CreativeTabs.tabTools);
        lightStoneDust = (new Item(92)).setIconCoord(9, 4).setItemName("yellowDust").setPotionEffect(PotionHelper.glowstoneEffect).setTabToDisplayOn(CreativeTabs.tabMaterials);
        bone = (new Item(96)).setIconCoord(12, 1).setItemName("bone").setFull3D().setTabToDisplayOn(CreativeTabs.tabMisc);
        sugar = (new Item(97)).setIconCoord(13, 0).setItemName("sugar").setPotionEffect(PotionHelper.sugarEffect).setTabToDisplayOn(CreativeTabs.tabMaterials);
        cake = (new ItemReed(98, Block.cake)).setMaxStackSize(1).setIconCoord(13, 1).setItemName("cake").setTabToDisplayOn(CreativeTabs.tabFood);
        redstoneRepeater = (new ItemReed(100, Block.redstoneRepeaterIdle)).setIconCoord(6, 5).setItemName("diode").setTabToDisplayOn(CreativeTabs.tabRedstone);
        ...
        blazeRod = (new Item(113)).setIconCoord(12, 6).setItemName("blazeRod").setTabToDisplayOn(CreativeTabs.tabMaterials);
        ghastTear = (new Item(114)).setIconCoord(11, 7).setItemName("ghastTear").setPotionEffect(PotionHelper.ghastTearEffect).setTabToDisplayOn(CreativeTabs.tabBrewing);
        goldNugget = (new Item(115)).setIconCoord(12, 7).setItemName("goldNugget").setTabToDisplayOn(CreativeTabs.tabMaterials);
        ...
        fermentedSpiderEye = (new Item(120)).setIconCoord(10, 8).setItemName("fermentedSpiderEye").setPotionEffect(PotionHelper.fermentedSpiderEyeEffect).setTabToDisplayOn(CreativeTabs.tabBrewing);
        blazePowder = (new Item(121)).setIconCoord(13, 9).setItemName("blazePowder").setPotionEffect(PotionHelper.blazePowderEffect).setTabToDisplayOn(CreativeTabs.tabBrewing);
        magmaCream = (new Item(122)).setIconCoord(13, 10).setItemName("magmaCream").setPotionEffect(PotionHelper.magmaCreamEffect).setTabToDisplayOn(CreativeTabs.tabBrewing);
        brewingStand = (new ItemReed(123, Block.brewingStand)).setIconCoord(12, 10).setItemName("brewingStand").setTabToDisplayOn(CreativeTabs.tabBrewing);
        cauldron = (new ItemReed(124, Block.cauldron)).setIconCoord(12, 9).setItemName("cauldron").setTabToDisplayOn(CreativeTabs.tabBrewing);
        speckledMelon = (new Item(126)).setIconCoord(9, 8).setItemName("speckledMelon").setPotionEffect(PotionHelper.speckledMelonEffect).setTabToDisplayOn(CreativeTabs.tabBrewing);
        writableBook = (new ItemWritableBook(130)).setIconCoord(11, 11).setItemName("writingBook").setTabToDisplayOn(CreativeTabs.tabMisc);
        emerald = (new Item(132)).setIconCoord(10, 11).setItemName("emerald").setTabToDisplayOn(CreativeTabs.tabMaterials);
        StatList.initStats();
    }
}
