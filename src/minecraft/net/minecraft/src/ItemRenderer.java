...
public class ItemRenderer
{
    ...
    public void renderItemInFirstPerson(float par1)
    {
        ...
        if (entityclientplayermp instanceof EntityPlayerSP)
        {
            ...
            GL11.glRotatef((((EntityPlayer)(entityclientplayermp)).rotationPitch - f2) * 0.1F, 1.0F, 0.0F, 0.0F);
            GL11.glRotatef((((EntityPlayer)(entityclientplayermp)).rotationYaw - f4) * 0.1F, 0.0F, 1.0F, 0.0F);
        }
