...
public class ModelRenderer
{
    ...
    public void render(float par1)
    {
        ...
        if (rotateAngleX != 0.0F || rotateAngleY != 0.0F || rotateAngleZ != 0.0F)
        {
            ...
            if (childModels != null)
            {
                ...
                for (Iterator iterator = childModels.iterator(); iterator.hasNext(); modelrenderer.render(par1))
                {
        ...
        else if (rotationPointX != 0.0F || rotationPointY != 0.0F || rotationPointZ != 0.0F)
        {
            ...
            if (childModels != null)
            {
                ...
                for (Iterator iterator1 = childModels.iterator(); iterator1.hasNext(); modelrenderer1.render(par1))
                {
        ...
        else
        {
            ...
            if (childModels != null)
            {
                ...
                for (Iterator iterator2 = childModels.iterator(); iterator2.hasNext(); modelrenderer2.render(par1))
                {
    ...
    private void compileDisplayList(float par1)
    {
        ...
        for (Iterator iterator = cubeList.iterator(); iterator.hasNext(); modelbox.render(tessellator, par1))
        {
