...
public class ModelSilverfish extends ModelBase
{
    ...
    public ModelSilverfish()
    {
        ...
        silverfishWings[0].setRotationPoint(0.0F, 16F, field_78170_c[2]);
        ...
        silverfishWings[1].setRotationPoint(0.0F, 20F, field_78170_c[4]);
        ...
        silverfishWings[2].setRotationPoint(0.0F, 19F, field_78170_c[1]);
    }
    ...
    public void render(Entity par1Entity, float par2, float par3, float par4, float par5, float par6, float par7)
    {
        ...
        ModelRenderer amodelrenderer[] = silverfishBodyParts;
