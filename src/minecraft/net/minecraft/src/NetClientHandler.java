...
public class NetClientHandler extends NetHandler
{
    ...
    public void handleLogin(Packet1Login par1Packet1Login)
    {
        ...
        worldClient = new WorldClient(this, new WorldSettings(0L, par1Packet1Login.gameType, false, par1Packet1Login.field_73560_c, par1Packet1Login.terrainType), par1Packet1Login.dimension, par1Packet1Login.difficultySetting, mc.field_71424_I);
    ...
    public void handleRespawn(Packet9Respawn par1Packet9Respawn)
    {
        ...
        {
            doneLoadingTerrain = false;
            worldClient = new WorldClient(this, new WorldSettings(0L, par1Packet9Respawn.gameType, false, mc.theWorld.getWorldInfo().isHardcoreModeEnabled(), par1Packet9Respawn.terrainType), par1Packet9Respawn.respawnDimension, par1Packet9Respawn.difficulty, mc.field_71424_I);
            worldClient.isRemote = true;
            mc.func_71403_a(worldClient);
    ...
    {
        mc.theWorld.sendClientEvent(par1Packet54PlayNoteBlock.xLocation, par1Packet54PlayNoteBlock.yLocation, par1Packet54PlayNoteBlock.zLocation, par1Packet54PlayNoteBlock.blockId, par1Packet54PlayNoteBlock.instrumentType, par1Packet54PlayNoteBlock.pitch);
    }
    ...
    public void handlePlayerAbilities(Packet202PlayerAbilities par1Packet202PlayerAbilities)
    {
        ...
        ((EntityPlayer)(entityclientplayermp)).capabilities.setFlySpeed(par1Packet202PlayerAbilities.func_73347_i());
    }
