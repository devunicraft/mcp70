...
public class Packet20NamedEntitySpawn extends Packet
{
    ...
    private DataWatcher receivedMetadata;
    ...
    public Packet20NamedEntitySpawn(EntityPlayer par1EntityPlayer)
    {
        ...
        receivedMetadata = par1EntityPlayer.getDataWatcher();
    }
    ...
    public void readPacketData(DataInputStream par1DataInputStream) throws IOException
    {
        ...
        field_73517_j = DataWatcher.readWatchableObjects(par1DataInputStream);
    }
    ...
    public void writePacketData(DataOutputStream par1DataOutputStream) throws IOException
    {
        ...
        receivedMetadata.writeWatchableObjects(par1DataOutputStream);
    }
    ...
    public List func_73509_c()
    {
        ...
        {
            field_73517_j = receivedMetadata.func_75685_c();
        }
