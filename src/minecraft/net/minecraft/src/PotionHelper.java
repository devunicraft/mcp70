...
public class PotionHelper
{
    ...
    public static int func_77915_a(int par0, boolean par1)
    {
        if (!par1)
        {
            ...
            else
            {
                ...
                field_77925_n.put(Integer.valueOf(par0), Integer.valueOf(i));
                return i;
            }
        }
        else
    ...
    private static int parsePotionEffects(String par0Str, int par1, int par2, int par3)
    {
        ...
        for (int j2 = par1; j2 < par2; j2++)
        {
            ...
            if (c == '!')
            {
                if (flag2)
                {
                    i2 += func_77904_a(flag3, flag1, flag4, byte0, k1, l1, par3);
    ...
    public static List getPotionEffects(int par0, boolean par1)
    {
        ...
        for (int j = 0; j < i; j++)
        {
            ...
            int l = 0;
            String s1 = (String)field_77928_m.get(Integer.valueOf(potion.getId()));
