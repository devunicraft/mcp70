...
public class RenderMagmaCube extends RenderLiving
{
    ...
    {
        int i = ((ModelMagmaCube)mainModel).func_78107_a();
    ...
    protected void scaleMagmaCube(EntityMagmaCube par1EntityMagmaCube, float par2)
    {
        ...
        float f = (par1EntityMagmaCube.field_70812_c + (par1EntityMagmaCube.field_70811_b - par1EntityMagmaCube.field_70812_c) * par2) / ((float)i * 0.5F + 1.0F);
