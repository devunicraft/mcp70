...
public class RenderOcelot extends RenderLiving
{
    ...
    {
        func_77116_a((EntityOcelot)par1EntityLiving, par2);
    }

    public void doRenderLiving(EntityLiving par1EntityLiving, double par2, double par4, double par6, float par8, float par9)
    {
        func_77117_a((EntityOcelot)par1EntityLiving, par2, par4, par6, par8, par9);
    }
    ...
    {
        func_77117_a((EntityOcelot)par1Entity, par2, par4, par6, par8, par9);
    }
}
