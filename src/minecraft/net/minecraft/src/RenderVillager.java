...
public class RenderVillager extends RenderLiving
{
    ...
    public RenderVillager()
    {
        ...
        field_77056_a = (ModelVillager)mainModel;
    }
    ...
    {
        func_77055_a((EntityVillager)par1EntityLiving, par2, par4, par6);
    }
    ...
    {
        func_77052_b((EntityVillager)par1EntityLiving, par2);
    }
    ...
    {
        return func_77053_a((EntityVillager)par1EntityLiving, par2, par3);
    }

    protected void renderEquippedItems(EntityLiving par1EntityLiving, float par2)
    {
        func_77051_a((EntityVillager)par1EntityLiving, par2);
    }
