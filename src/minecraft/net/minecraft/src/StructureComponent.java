...
public abstract class StructureComponent
{
    ...
    protected int getMetadataWithOffset(int par1, int par2)
    {
        ...
        else if (par1 == Block.stairCompactCobblestone.blockID || par1 == Block.stairCompactPlanks.blockID || par1 == Block.stairsNetherBrick.blockID || par1 == Block.stairsStoneBrickSmooth.blockID || par1 == Block.stairsSandStone.blockID)
        {
            if (coordBaseMode == 0)
            {
                if (par2 == 2)
    ...
    protected boolean func_74879_a(World par1World, StructureBoundingBox par2StructureBoundingBox, Random par3Random, int par4, int par5, int par6, WeightedRandomChestContent par7ArrayOfWeightedRandomChestContent[], int par8)
    {
        ...
        if (par2StructureBoundingBox.isVecInside(i, j, k) && par1World.getBlockId(i, j, k) != Block.chest.blockID)
        {
            ...
            {
                WeightedRandomChestContent.func_76293_a(par3Random, par7ArrayOfWeightedRandomChestContent, tileentitychest, par8);
            }
    ...
    protected boolean func_74869_a(World par1World, StructureBoundingBox par2StructureBoundingBox, Random par3Random, int par4, int par5, int par6, int par7, WeightedRandomChestContent par8ArrayOfWeightedRandomChestContent[], int par9)
    {
        ...
        if (par2StructureBoundingBox.isVecInside(i, j, k) && par1World.getBlockId(i, j, k) != Block.dispenser.blockID)
        {
            ...
            {
                WeightedRandomChestContent.func_76294_a(par3Random, par8ArrayOfWeightedRandomChestContent, tileentitydispenser, par9);
            }
