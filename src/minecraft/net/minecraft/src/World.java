...
public abstract class World implements IBlockAccess
{
    ...
    public int getBlockLightValue_do(int par1, int par2, int par3, boolean par4)
    {
        ...
        if (par4)
        {
            ...
            if (i == Block.stairSingle.blockID || i == Block.woodSingleSlab.blockID || i == Block.tilledField.blockID || i == Block.stairCompactCobblestone.blockID || i == Block.stairCompactPlanks.blockID)
            {
